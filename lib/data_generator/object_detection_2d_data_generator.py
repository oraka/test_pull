                ...
                if not annotations_dir is None:
                    ...
                    for obj in objects:
                        ...
                        if not class_name in self.classes: 
                            warnings.warn("filename = {} のアノテーションに不正なクラス名[{}]が含まれています。".format(filename,class_name))
                            continue
                        ...
                        if not self.include_classes == 'all': 
                            if not class_name in self.include_classes: 
                                continue
                           
                        # kikuchi
                        if not self.include_classes == "all":
                            class_id = self.include_classes.index(class_name)
