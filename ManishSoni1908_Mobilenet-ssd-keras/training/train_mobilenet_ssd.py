...
def train(args):
  ...
  # include_classes = ['background','cat','boat']
  ...
  # train_dataset.parse_xml(images_dirs=["../datasets/2attrvoc/train/images/"],
  #                         image_set_filenames=["../datasets/2attrvoc/trainlist.txt"],
  #                         annotations_dirs=["../datasets/2attrvoc/train/annotations/"],
  #                         classes=classes,
  ...
  # val_dataset.parse_xml(images_dirs=["../datasets/2attrvoc/val/images/"],
  #                         image_set_filenames=["../datasets/2attrvoc/vallist.txt"],
  #                         annotations_dirs=["../datasets/2attrvoc/val/annotations/"],
  #                       classes=classes,
  #                       include_classes=include_classes,
  #                       exclude_truncated=False,
  #                       exclude_difficult=False,
  ...
  open(os.path.join('f_model,''2attr_model.json'), 'w').write(json_string)
